...
note = client.files.create(
  file=open("lecture_notes/2.ipynb", "rb"),
  purpose='assistants'
)
print(note)
...
student = client.files.create(
  file=open("code_attempts_1/attempt2.ipynb", "rb"),
  purpose='assistants'
)
print(student)
...
with open('responses11.txt', 'w') as file:
